...
╭➣᳆⃟✪𝐁𝐘 𝐓𝐔𝐑𝐁𝐎✪᳆͜͡➣╮
│ ${msg.gp} 1
│https://chat.whatsapp.com/B5wLjbgBb938XuxcqqiEae
╰•⋆҈͜͡ ⫘ 𝐓𝐔𝐑𝐁𝐎⋆𝐍𝐓𝐑 ⫘⋆҈͜͡•╯
`
m.reply(gps)
break 
...
case 'creador': 
case 'developer':
number = '79524197466@s.whatsapp.net'
    capt = `▢ ${msg.num} : @${number.split('@')[0]}\n\n`
    capt += '▢ WhatsApp: https://chat.whatsapp.com/B5wLjbgBb938XuxcqqiEae'
    await Turbo.fakeLink(from, capt, thumbfg, `${msg.click}`, 'https://chat.whatsapp.com/B5wLjbgBb938XuxcqqiEae', mek)
...
*≡ OWNER*
▢ Ватсап группа : https://chat.whatsapp.com/B5wLjbgBb938XuxcqqiEae
▢ WhatsApp : wa.me/79524197466
